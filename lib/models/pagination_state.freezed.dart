...
class _$_Data<T> with DiagnosticableTreeMixin implements _Data<T> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'PaginationState<$T>.data'))
...
class _$_OnGoingLoading<T>
    with DiagnosticableTreeMixin
    implements _OnGoingLoading<T> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'PaginationState<$T>.onGoingLoading'))
      ..add(DiagnosticsProperty('items', items));
  }
...
class _$_OnGoingError<T>
    with DiagnosticableTreeMixin
    implements _OnGoingError<T> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'PaginationState<$T>.onGoingError'))
      ..add(DiagnosticsProperty('items', items))
      ..add(DiagnosticsProperty('e', e))
      ..add(DiagnosticsProperty('stk', stk));
  }
